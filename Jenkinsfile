          ...
          steps {
              ...
              script {
                  ...
                  sshagent(['server-key']) {
                      ...
                      sh "ssh -o StrictHostKeyChecking=no ubuntu@10.0.11.225 'docker rmi aj4941/morandi-server || true'"
                      sh "ssh -o StrictHostKeyChecking=no ubuntu@10.0.11.225 'docker pull aj4941/morandi-server'"
                      sh "ssh -o StrictHostKeyChecking=no ubuntu@10.0.11.225 'docker run -d -p 8080:8080 --name morandi-container aj4941/morandi-server sleep infinity'"
                  }
              }
          }
       }
