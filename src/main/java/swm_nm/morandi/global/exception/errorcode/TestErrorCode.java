...
public enum TestErrorCode implements ErrorCode {
    TEST_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "테스트를 찾을 수 없습니다."),
    CODE_TYPE_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "제출 코드 유형을 찾을 수 없습니다."),
    ...
    KEY_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "키를 찾을 수 없습니다.");
