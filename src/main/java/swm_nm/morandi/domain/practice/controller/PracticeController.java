...
public class PracticeController {
    ...
    public PracticeStartResponseDto practiceStart(@RequestBody PracticeStartDto practiceStartDto) {
        return practiceProblemService.startPractices(practiceStartDto.getBojProblemId());
    }
    @PostMapping("/exit")
