...
public class MemberListService {
    ...
    public List<MemberListResponseDto> findAll(MemberListRequestDto memberListRequestDto) {
        Integer page = memberListRequestDto.getPage();
        Integer size = memberListRequestDto.getSize();
